...
describe('AppState', () => {
  ...
  describe('toggleBisectCommands()', () => {
    it('toggles visibility of the bisect commands', () => {
      const isVisible = appState.isBisectCommandVisible;
      appState.toggleBisectCommands();
      expect(isVisible).not.toBe(appState.isBisectCommandVisible);
    });
    ...
    it('takes no action if bisect dialog is active', () => {
      ...
      appState.toggleBisectCommands();
      expect(isVisible).toBe(appState.isBisectCommandVisible);
    });
